...
func (r *UserRecipeRepository) GetUserRecipes(userID int64) []models.SavedRecipe {
...
func (r *UserRecipeRepository) AddUserRecipe(userID int64, recipeID int64) int64 {
...
func (r *UserRecipeRepository) RemoveUserRecipe(userID int64, recipeID int64) int64 {
